...
public class changeINClient {
   ...
   public static ArrayList<String> getList(String ip) throws IOException {
    ...
    /*public static ArrayList<String> getList(String ip) throws IOException, ParserConfigurationException, SAXException {

       ArrayList<String> list = Utils.getVideoUrls(ip+"video.mpd");
       return list;
    }*/

    public static ArrayList<String> getCoClient(String ip) throws Exception {
        Document doc = Jsoup.connect("http://" + ip + ":8081/sip").get();
   ...
   public static void newCli(String copyingFolder,String Dest,String ipAddress,String myPort,String fileName)
   {
    ...
    public static class clientThreadnew implements Runnable {
        ...
        public void run() {
            ...
            TestIp(ipAddress,address+" "+"id = "+myId);
            ...
            while(true) {
                ...
                if (connectPort != 0) {
                    ...
                    serverThread.start();
                    System.out.println("Client-Server " + myId + " has Started");
                    for (int j = 0; j < totalFileList.size(); j++) {
                        ...
                        int rn = random.nextInt(2000) + 500;
                    ...
                    System.out.println("I am trying once again to get ny port and ip");
                    try {
                        Thread.sleep(1000);
                    } catch (InterruptedException e) {
                        e.printStackTrace();
